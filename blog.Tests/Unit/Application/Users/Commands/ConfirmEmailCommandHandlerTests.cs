...
namespace blog.Tests.Unit.Application.Users.Commands
{
    public class ConfirmEmailCommandHandlerTests
    {
        ...
        private static ConfirmEmailCommand CreateValidCommand(string email = "test@test.com") => new()
        {
            Email = email,
            Code = "ABC123",
        ...
        public async Task Handle_InvalidCode_ThrowsValidationException()
        {
            ...
            var verification = new EmailVerification(user.Id, "correct_hash", EmailVerificationPurpose.Registration, 15);
        ...
        [Fact]
        public async Task Handle_InvalidCode_DoesNotConfirmUserOrIssueTokens()
        {
            // Arrange
            var user = CreateUnconfirmedUser();
            var command = CreateValidCommand();
        ...
        [Fact]
        public async Task Handle_ValidCode_ReturnsTokensAndUserInfo()
        {
            // Arrange
            var user = CreateUnconfirmedUser();
            var command = CreateValidCommand();
        ...
        [Fact]
        public async Task Handle_ValidCode_ConfirmsUserEmail()
        {
            // Arrange
            var user = CreateUnconfirmedUser();
            var command = CreateValidCommand();
