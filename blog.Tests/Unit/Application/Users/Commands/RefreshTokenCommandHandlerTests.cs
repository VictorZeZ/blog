...
namespace blog.Tests.Unit.Application.Users.Commands
{
    public class RefreshTokenCommandHandlerTests
    {
        ...
        private static RefreshToken ValidToken(UserId userId)
            => new("valid_refresh_token", userId, "Mozilla/5.0 Chrome/120", expiryDays: 30);
        ...
        public async Task Handle_ExpiredToken_ThrowsExpiredException()
        {
            ...
            var command = ValidCommand;
            var user = ValidUser;
            var token = new RefreshToken("valid_refresh_token", user.Id, "Mozilla/5.0 Chrome/120", expiryDays: -1);
